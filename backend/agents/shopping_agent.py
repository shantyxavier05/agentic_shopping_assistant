...
class ShoppingAgent:
    ...
    def get_missing_items(self, recipe_ingredients: List[Dict]) -> List[Dict]:
        """
        Check which recipe ingredients are missing or insufficient
        
        Args:
            recipe_ingredients: List of required ingredients with quantities
            
        Returns:
            List of missing or insufficient items
        """
        try:
            missing_items = []
            inventory = {item["name"].lower(): item for item in self.db_helper.get_all_inventory()}
            ...
            for ingredient in recipe_ingredients:
                ...
                if item_name_lower not in inventory:
                    ...
                    available = inventory[item_name_lower]
            ...
            logger.error(f"Error checking missing items: {str(e)}")
            return []
